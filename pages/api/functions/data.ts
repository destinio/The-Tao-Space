    ...
    sections: [
      {
        ...
        lines: [
          ...
          'How deep and unfathomable it is, the Ancestor of all things!',
        ],
      },
      {
        section_number: 2,
      ...
      },
      {
        ...
        lines: [
          ...
          'It might appear to have been the ancestor of all.',
        ],
      },
    ],
    notes: [
      'Part 1: Talks about Infinity',
      'Part 2: What happens to things in Infinity',
      'Part 3: Infinity is hidden but always present',
      'Consider infinity every day!',
      '',
